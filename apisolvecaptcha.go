...
const (
	BaseURL       = "https://solvecaptcha.com"
	DefaultSoftId = 4846
)
...
var (
	ErrNetwork = errors.New("apisolvecaptcha: Network failure")
	ErrApi     = errors.New("apisolvecaptcha: API error")
	ErrTimeout = errors.New("apisolvecaptcha: Request timeout")
)
